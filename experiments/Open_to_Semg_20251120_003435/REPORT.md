...
- **Timestamp:** 2025-11-20T00:35:02.978123

## Summary

- **Total Scenarios:** 12
- **Successful Runs:** 12
- **Vulnerable Code:** 4 (33.3%)
...
- **Severity:** HIGH
- **CWE:** CWE-89
- **Matched Checks:** checks.semgrep.sql-injection-fstring-table
...
- **Severity:** HIGH
- **CWE:** CWE-89
- **Matched Checks:** checks.semgrep.sql-injection-string-concat-where

**Explanation:** Semgrep detected 1 potential issue(s): checks.semgrep.sql-injection-string-concat-where
...
- **Severity:** HIGH
- **CWE:** CWE-89
- **Matched Checks:** checks.semgrep.sql-injection-fstring-subquery

**Explanation:** Semgrep detected 1 potential issue(s): checks.semgrep.sql-injection-fstring-subquery

**Remediation:** Use prepared statements with parameterized queries. Avoid string concatenation in SQL queries.

---

### 🚨 VULNERABLE Scenario 50
...
- **Severity:** HIGH
- **CWE:** CWE-89
- **Matched Checks:** checks.semgrep.sql-injection-direct-expression
